<template>
  <section class="font-mono relative w-full" data-aos="zoom-in-up">
    <div class="absolute top-0 inset-x-0 h-64 flex items-start">
      <div class="h-24 w-2/3 bg-gradient-to-br from-[#4a5aec] blur-2xl invisible opacity-40"></div>
      <div class="h-20 w-3/5 bg-gradient-to-r from-[#5a5aec] opacity-40 blur-2xl"></div>
    </div>
      ...
      <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
        <div class="lg:py-6">
          <div class="text-center lg:text-left">
            <h1 class="pt-4 text-[#4D4D4D] font-bold text-4xl md:text-5xl lg:text-6xl">
              Hi, I'm <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#4D4D4D] to-[#4a5aec]">Marvin</span>
            </h1>
          </div>
          <p class="text-[#4D4D4D] pt-8 text-center lg:text-left mx-auto max-w-xl">
            ...
            <button class="border border-[#4d4d4d] px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
              ...
              <div class="svg-container">
                <svg class="download-icon" width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path class="download-arrow" d="M13 9L9 13M9 13L5 9M9 13V1" stroke="#4d4d4d" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  stroke="#4d4d4d" stroke-width="2" stroke-linecap="round"></path>
                </svg>
        ...
        <div class="lg:h-full md:flex">
          <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
            <div class="absolute z-0 top-1/2 -translate-y-1/2 w-5/6 right-0 h-[calc(80%+20px)] bg-gradient-to-tr opacity-25 from-[#4a5aec] to-[#5a5aec] blur-2xl"></div>
            <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-[#4d4d4d]">
              <img src="@/assets/top_picture.jpg" alt="Hero Photo" width="500" height="auto" loading="lazy"
